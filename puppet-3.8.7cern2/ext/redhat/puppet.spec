...
%global realversion 3.8.7cern2
%global rpmversion 3.8.7cern2
...
%else
if [ "$1" = 0 ] ; then
    # Disable stop to help puppet -> puppet-agent migration
...
%changelog
* Wed Mar 08 2017 Puppet Labs Release <info@puppetlabs.com> -  3.8.7cern2-1
- Build for 3.8.7cern2
